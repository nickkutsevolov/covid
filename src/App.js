    ...
    <>
      ...
      <div className="flex m-16">
        <div id='totalChart' className="w-1/3 p-12">
          ...
          <p className="text-l">This chart shows the total number of COVID&#8209;19 cases by day. You can select a country from the dropdown list and specify a timea selecting one of the options. By the thickness of the gray area you can see the proportionate amount of active cases to its total. Hover the chart to see the exact numbers by day. Please note that some countries do not provide full COVID&#8209;19 statistics.</p>
        </div>
        <TotalChart />
      </div>
      <div className="flex m-16">
        ...
        <div id='tendencyChart' className="w-1/3 p-12">
          ...
          <p className="text-l">This chart shows the number of new COVID&#8209;19 cases by day. You can select a country from the dropdown list and specify a timea selecting one of the options. By the height of the bars you can see the number of people infected, recovered or died. The difference between the positive bar(dead and recovered) and the negative(infected) shows whether the virus spread is slowing down or not. Hover the chart to see the exact numbers by day. Please note that some countries do not provide full COVID&#8209;19 statistics or they may publish cumulative data on certain days which results in high pikes on the chart.</p>
        </div>
      </div>
      <Table />
    </>
